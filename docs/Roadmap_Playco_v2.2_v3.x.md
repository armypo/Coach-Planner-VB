...
| **2.6.2** | ✅ 2026-07-07 (294/294) | PDF « Plan de pratique » une page (heure·exercice·diagramme miniature·consignes + présences à cocher — `PDFExportService` rodé). Casable dans la fenêtre 2.2.5+ | 2-3 j |
